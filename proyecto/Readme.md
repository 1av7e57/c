...
Encontrar la salida (`S`) en el **menor número de movimientos posible**. El juego te muestra cuántos pasos mínimos necesitas al inicio — ¡intenta igualarlo o superarlo!
