...
en la función 'validarMovimiento()'.*/
#include <stdbool.h>
...
// Devuelve un 'int', toma un carácter como entrada.
...
(es decir, si es 'w', 'a', 's', 'd', o 'q'), 
evitando que el juego tome teclas inválidas.
Se llama en 'main()' para validar la opción del menú principal.*/
int validarMovimiento(char input) {
