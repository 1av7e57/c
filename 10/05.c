/*Ejercicio 5: Total y Promedio por Grupo
Escribe un programa que lea números y su
respectivo grupo desde un archivo. El programa
debe calcular el total y el promedio de cada
grupo.
Instrucciones:
-El archivo debe contener números y su
grupo en formato numero grupo.
-El programa debe mostrar el total y el
